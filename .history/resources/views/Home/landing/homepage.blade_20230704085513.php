                            ...
                            <div class="row d-flex mb-4">
                                <div class="col-md-4 d-flex align-self-stretch ftco-animate">
                                    <div class="services w-100 text-center">
                                        {{-- <div class="text w-100">
                                            <h2 class="heading mb-2">Rp {{ $car['price'] }},-</h2>
                                        </div> --}}
                                        <div class="text w-100">
                                            <h2 class="heading mb-2">Choose Your Pickup Location</h2>
                                        </div>
                                        <div class="text w-100">
                                ...
                                <div class="col-md-4 d-flex align-self-stretch ftco-animate">
                                    <div class="services w-100 text-center">
                                        ...
                                        <div class="text w-100">
                                            <h2 class="heading mb-2">Select the Best Deal</h2>
                                        </div>
                                        <div class="text w-100">
                                ...
                                <div class="col-md-4 d-flex align-self-stretch ftco-animate">
                                    <div class="services w-100 text-center">
                                        ...
                                        <div class="text w-100">
                                            <h2 class="heading mb-2">Reserve Your Rental Car</h2>
                                        </div>
                                        <div class="text w-100">
