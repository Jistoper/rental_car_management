                                    ...
                                    <div class="text">
                                        ...
                                        <p class="d-flex mb-0 d-block">
                                            @if ($cars['is_available'])
                                                <button type="button" class="btn btn-primary py-2 mr-1 bi-handbag-fill" data-bs-toggle="modal" data-bs-target="#AddRental{{ $cars['car_id'] }}" onclick="setMinDate({{ $i }})"> Book Now</button>
                                            @endif
            ...
            <div class="modal-dialog modal-xl">
                <div class="modal-content">
                    ...
                    <div class="modal-body"> --}}
                        <form action="{{ route('car.rentStore', $cars['car_id']) }}" method="POST" class="request-form bg-primary row g-3 needs-validation" novalidate>
                            @csrf
