					...
					<div class="col-md-4">
						<div class="car-wrap rounded ftco-animate">
							...
							<div class="text">
								...
								<p class="d-flex mb-0 d-block"><a href="#" class="btn btn-primary py-2 mr-1">Book now</a> <button type="button" class="btn btn-secondary py-2 ml-1" data-bs-toggle="modal" data-bs-target="#EditCar{{ $car['car_id'] }}">Details</button> <a href="car-single.html" class="btn btn-secondary py-2 ml-1">Details</a></p>
							</div>
						</div>
					</div>
				@endforeach
