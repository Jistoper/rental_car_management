            ...
            <div class="modal-dialog modal-xl">
                <div class="modal-content">
                    ...
                    <div class="row no-gutters">
                        <div class="col-md-12">
                            <div class="row no-gutters">
                                <form action="{{ route('car.rentStore', $cars['car_id']) }}" method="POST" class="text-white request-form bg-primary row g-3 needs-validation" novalidate>
                                    @csrf
                                ...
                                <div class="col-md-8 d-flex align-items-center">
                                    <div class="services-wrap rounded-right w-100">
                                        ...
                                        <p class="align-items-right">
                                            <button type="button" class="btn btn-outline-secondary rounded-pill py-2 px-4" data-bs-dismiss="modal">Cancel</button>
                                        </p>
                                    </div>
                                </div>
                            </div>
