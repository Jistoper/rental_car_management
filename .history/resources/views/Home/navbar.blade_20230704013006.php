  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="ftco-nav">
      ...
      <ul class="navbar-nav ml-auto">
        @guest
        <li class="nav-item">
          <a href="{{ route('login') }}" class="btn btn-success py-2 px-3">
            Get Started
          </a>
        </li>
        @else
        ...
        <div class="btn-group" role="group">
          <a href="{{ route('admin.dashboard') }}" class="btn btn-success py-2 px-3">
            Dashboard
          </a>
        ...
        @else
        <div class="btn-group" role="group">
          <a href="{{ route('profile.index') }}" class="btn btn-success py-2 px-3">
            Profile
          </a>
          <form action="{{ route('logout') }}" method="POST">
            @csrf
