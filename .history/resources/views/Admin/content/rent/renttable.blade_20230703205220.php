...
<script>
    function calculateTotalPrice(id) {
        var rentDate = new Date(document.querySelector('rent_date')[id].value);
        var returnDate = new Date(document.querySelector('return_date')[id].value);
        ...
        if (!isNaN(rentDate.getTime()) && !isNaN(returnDate.getTime())) {
            ...
            document.querySelector('input[id="total_price"]')[id].value = pricePerDay.toString();
        }
        else {
            document.querySelector('input[id="total_price"]')[id].value = "0";
        }
    }
</script>
