...
<script>
    function calculateTotalPrice() {
        var rentDate = new Date(document.querySelector('rent_date').value);
        var returnDate = new Date(document.querySelector('return_date').value);
        ...
        if (!isNaN(rentDate.getTime()) && !isNaN(returnDate.getTime())) {
            ...
            document.querySelector('input[id="total_price"]')[1].value = totalPrice.toString();
        }
        else {
            document.querySelector('input[id="total_price"]')[1].value = "0";
        }
    }
</script>
