...
<script>
    function calculateTotalPrice(var id) {
        var ids = id;
        ...
        if (!isNaN(rentDate.getTime()) && !isNaN(returnDate.getTime())) {
            ...
            document.querySelectorAll('input[id="total_price"]')[ids].value = totalPrice.toString();
        }
        else {
            document.querySelectorAll('input[id="total_price"]')[ids].value = "0";
        }
    }
</script>
