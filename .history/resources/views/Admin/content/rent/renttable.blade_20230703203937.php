...
<script>
    function calculateTotalPrice(id) {
        var rentDate = new Date(document.getElementById('rent_date')[id].value);
        var returnDate = new Date(document.getElementById('return_date')[id].value);
        ...
        if (!isNaN(rentDate.getTime()) && !isNaN(returnDate.getTime())) {
            ...
            document.querySelectorAll('input[id="total_price"]')[id].value = pricePerDay.toString();
        }
        else {
            document.querySelectorAll('input[id="total_price"]')[id].value = rentDate.getTime().toString();
        }
    }
</script>
