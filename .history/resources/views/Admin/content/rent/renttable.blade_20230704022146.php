...
<script>
    function calculateTotalPrice(id) {
        ...
        var price = new Date(document.querySelectorAll('input[id="price"]')[id].value);
        ...
        if (!isNaN(rentDate.getTime()) && !isNaN(returnDate.getTime())) {
            ...
            document.querySelectorAll('input[id="total_price"]')[id].value = price;
        }
    }
